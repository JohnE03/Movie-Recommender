...
public class Recommender {
    ...
    public static void main(String[] args){
        /*Movie movie=new Movie("The Shawshank Redemption", new String[]{"Drama"});
        Movie movie2=new Movie("The Godfather", new String[]{"Crime","Drama"});
        Movie movie3=new Movie("The Dark Knight", new String[]{"Action", "Crime", "Drama"});

        System.out.println(movieTitleCheck(movie3.getTitle()));

        String name="Hassan Ali";
        String id="12345678X";
        User user=new User(name,id,new String[]{"TSR1","TDK3"});

        String name2="Ali Mohamed";
        String id2="87654321W";
        User user2=new User(name,id,new String[]{"TG2"});

        System.out.println("user1 movies: "+ Arrays.toString(user.getUserMovies()));
        System.out.println("user2 movies: "+Arrays.toString(user2.getUserMovies()));*/
        ...
        /*System.out.println("-----------------------"); //Checking if created
        for(int i=0;i<Movie.getCount();i++){
            System.out.println(Movie.getMovies().get(i).getTitle());
        }*/
        ...
        for(int i=0;i<User.usersList.size();i++){
            System.out.println(User.usersList.get(i).getUserMovies());
        }*/
...
/*
* 1. movieTitleCheck
* 2. movieIdLettersCheck
* 3. movieIdNumbersCheck
* 4. userNameCheck
* 5. userIdCheck
